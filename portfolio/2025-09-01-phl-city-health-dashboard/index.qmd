...
::: {.g-col-4}
::: {.callout-note .custom-gray title="Data Engineers"}
Tamara Rushovich, Amber Bolli

- Aggregated census tract data to council district level
- Created static visualizations with R/ggplot2
- Provided text content and mockup of dashboard layout
:::
:::

::: {.g-col-4}
::: {.callout-note title="Data Architect (Ran Li)"}
<span style="font-weight:bold; color:#1976d2;">Ran Li</span>

- Tech stack design for zero budget and 3-month timeline with 5 hours/week capacity (budget-conscious architecture for operational sustainability)
:::
:::
...
- Implemented data preservation
- Develop R Shiny prototype
- Developed production application and iterated with stakeholders
:::
:::
